...
- **Chamadas internas detectadas:** `getItem`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `getItem`, `defaultState`, `parse`, `recalc`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Chamadas internas detectadas:** `r34TrimState`, `setItem`, `toast`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `payload`
- **Chamadas internas detectadas:** `currentAIDirector`, `render`, `aiFallback`, `fetch`, `apiHeaders`, `json`, `parse`, `normalizeAIResult`, `mergeWorldUpdates`, `toast`
...
- **Forma:** declaration
- **Parâmetros:** `file`
- **Chamadas internas detectadas:** `parse`, `defaultState`, `recalc`, `saveState`, `render`, `toast`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `values`, `xpNeeded`, `esc`, `originById`, `hijutsuById`, `variantById`, `today`, `bars`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `v`
- **Chamadas internas detectadas:** `parse`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `setItem`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `removeItem`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `getItem`, `newCreationDraft`, `parse`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `d=getCreationDraft(`
- **Chamadas internas detectadas:** `values`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Chamadas internas detectadas:** `getCreationDraft`, `hijutsuById`, `creationAttrSpent`, `creationSocialSpent`, `values`, `creationCombatMoved`, `creationSkillSpent`, `creationAptitudeAvailable`, `creationPowerSpent`, `professionById`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `id,delta`
- **Chamadas internas detectadas:** `getCreationDraft`, `values`, `writeCreationDraft`, `render`, `toast`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `getCreationDraft`, `values`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `parse`, `getItem`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `readSlotIndex`, `writeSlotIndex`, `setItem`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `id`
- **Chamadas internas detectadas:** `getItem`, `setItem`, `hydrateState`, `parse`, `render`, `toast`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `id`
- **Chamadas internas detectadas:** `readSlotIndex`, `removeItem`, `writeSlotIndex`, `defaultState`, `render`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `getItem`, `hydrateState`, `parse`, `newId`, `setItem`, `readSlotIndex`, `writeSlotIndex`, `defaultState`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `silent=false`
- **Chamadas internas detectadas:** `setItem`, `newId`, `updateSlotSummary`, `toast`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `getCreationDraft`, `validateCreationStep`, `writeCreationDraft`, `render`, `toast`, `newId`, `setItem`, `defaultState`, `r25CoreDefaults`, `r25LegacyFromCoreValues`, `professionById`, `itemById`, `recalc`, `saveState`, `clearCreationDraft`, `cloudSave`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `getCreationDraft`, `esc`, `originById`, `hijutsuById`, `bonusHuman`, `sourceShort`, `originBonusObject`, `creationAttrSpent`, `coreAttrKeys`, `socialAttrKeys`, `creationSocialSpent`, `values`, `creationCombatMoved`, `creationCombatTotal`, `creationSkillSpent`, `initialSkillBase`, `creationSkillTotal`, `creationAptitudeAvailable`, `professionById`, `creationPowerSpent`, `validateCreationStep`, `renderCreationProgress`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `silent=false`
- **Chamadas internas detectadas:** `toast`, `fetch`, `apiHeaders`, `json`, `setItem`
...
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `ensureV7State`, `leonPrivatePanel`, `villageArt`, `inventoryCompartments`, `esc`, `originById`, `fmt`, `values`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `key`
- **Chamadas internas detectadas:** `ensureV75State`, `clamp`, `v75Norm`, `rollLeon2d10`, `call`, `skillTotal`, `rollTerion2d10`, `saveState`, `render`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `getItem`, `v821ApplyLeonCanonical`, `hydrateState`, `parse`, `v821Clone`, `warn`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `toast`, `removeItem`, `v821LeonLocalState`, `ensureV7State`, `saveState`, `render`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `removeItem`, `v821LeonLocalState`, `ensureV7State`, `saveState`, `render`, `toast`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `event`
- **Chamadas internas detectadas:** `v83EnsureState`, `v83ClockLabel`, `values`, `v83ClockAbsolute`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `v83EnsureState`, `values`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Chamadas internas detectadas:** `v83EnsureState`, `v83BeginScene`, `v81IsLeon`, `v8StartLeonBattle`, `startBattle`, `saveState`, `render`, `values`, `v84TrainerCanUnlock`, `v83Hash`, `v83ClockLabel`, `v83Commit`, `toast`, `v82TrainingRoll`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Chamadas internas detectadas:** `v84SyncBattleTokens`, `esc`, `values`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `render`, `toast`, `v84NormKey`, `v84KnowledgeMeta`, `values`, `esc`, `test`, `v84KnowledgeImage`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `esc`, `v84NormKey`, `values`, `getItem`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `values`, `esc`, `v84NormKey`, `v841RecordName`, `v841RecordDesc`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Chamadas internas detectadas:** `setItem`, `removeItem`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `slotId`
- **Chamadas internas detectadas:** `render`, `accountApi`, `setAccountState`, `setItem`, `accountLocalKey`, `toast`, `v84Api`
...
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `accountToken`, `accountApi`, `getItem`, `parse`, `v821ApplyLeonCanonical`, `hydrateState`, `saveState`, `v841SyncAccountSave`, `render`, `v84Api`
- **Rotas referidas:** `/api/account/load`, `/api/v84/bootstrap`
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `accountToken`, `render`, `accountApi`, `cacheAccount`, `loadLeonAccount`, `loadAccountSlots`, `defaultState`, `removeItem`
...
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `accountApi`, `removeItem`, `defaultState`, `render`
...
- **Forma:** declaration
- **Parâmetros:** `slotId`
- **Chamadas internas detectadas:** `render`, `accountApi`, `removeItem`, `accountLocalKey`, `loadAccountSlots`, `toast`
...
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `readSlotIndex`, `parse`, `getItem`, `accountApi`, `loadAccountSlots`, `render`, `toast`
- **Rotas referidas:** `/api/account/save`
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `d`
- **Chamadas internas detectadas:** `values`, `clamp`, `r25CoreDefaults`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Chamadas internas detectadas:** `r29Ensure`, `r29ActiveCanonEvent`, `values`, `missionById`, `r29AssignMission`, `r29SideCandidates`, `r29MissionKind`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `r29Ensure`, `r29UpdatePromotionPending`, `toast`, `aiGameContext`, `values`, `callAI`, `aiFallback`, `warn`, `r29NormRank`, `test`, `v75Norm`, `saveState`, `render`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `j`
- **Chamadas internas detectadas:** `r31Category`, `r31Norm`, `add`, `test`, `values`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `o`
- **Chamadas internas detectadas:** `v83EnsureState`, `values`, `v83Hash`, `r31Clock`, `r31Commit`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `r31GeneratedItemPool`, `values`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `r31VisualCoverage`, `r31PlaceholderPolicy`, `itemById`, `r31Ensure`, `r27BattleDims`, `values`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `r29Ensure`, `values`, `missionById`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `m`
- **Chamadas internas detectadas:** `r32ActiveMission`, `missionById`, `r32MissionDependencyIds`, `r29Assignment`, `values`, `r29Ensure`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Chamadas internas detectadas:** `parse`, `getItem`, `setItem`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Fonte:** `cloudflare/oneclick-backend/src/index.js:9`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `bytes`
- **Chamadas internas detectadas:** `unb64url`, `sha256Text`, `hashPassword`, `timingSafe`, `randomBytes`, `randomSecret`, `norm`, `cleanText`, `bearer`, `get`, `test`, `nowIso`, `roomId`, `safeJson`, `parse`, `safeAccount`, `cors`, `reply`, `bodyJson`, `json`, `clampSaveForStorage`, `ensureSchema`, `audit`, `bind`, `issueToken`, `verifyToken`, `requireUser`, `revokeCurrent`, `slotSummary`, `hasForbiddenMechanicalResult`, `constructor`, `read`, `write`, `liveMembers`, `values`, `fetch`, `roomJson`, `aiRoute`, `handleApi`, `set`
...
- **DOM IDs:** —
- **Storage keys:** —
- **Env:** `ALLOWED_ORIGINS`, `DB`, `GAME_ROOMS`, `AI`, `PUBLIC_GAME_URL`
- **Ações UI literais:** —
- **Status:** `STATICALLY_TRACED`

## FUNC-00789 — `unb64url`

- **Fonte:** `cloudflare/oneclick-backend/src/index.js:10`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `s`
- **Chamadas internas detectadas:** —
...
## FUNC-00790 — `sha256Text`

- **Fonte:** `cloudflare/oneclick-backend/src/index.js:11`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `v`
...
## FUNC-00791 — `hashPassword`

- **Fonte:** `cloudflare/oneclick-backend/src/index.js:12`
- **Domínio:** `game-runtime`
- **Forma:** declaration
...
## FUNC-00792 — `timingSafe`

- **Fonte:** `cloudflare/oneclick-backend/src/index.js:13`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `a,b`
- **Chamadas internas detectadas:** —
...
## FUNC-00793 — `randomBytes`

- **Fonte:** `cloudflare/oneclick-backend/src/index.js:14`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `n=16`
- **Chamadas internas detectadas:** —
...
## FUNC-00794 — `randomSecret`

- **Fonte:** `cloudflare/oneclick-backend/src/index.js:15`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `n=32`
...
- **Fonte:** `cloudflare/oneclick-backend/src/index.js:16`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `v`
- **Chamadas internas detectadas:** —
...
## FUNC-00796 — `cleanText`

- **Fonte:** `cloudflare/oneclick-backend/src/index.js:17`
- **Domínio:** `game-runtime`
- **Forma:** declaration
...
- **Fonte:** `cloudflare/oneclick-backend/src/index.js:18`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `req`
...
- **Fonte:** `cloudflare/oneclick-backend/src/index.js:19`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** —
...
- **Fonte:** `cloudflare/oneclick-backend/src/index.js:20`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** —
...
- **Fonte:** `cloudflare/oneclick-backend/src/index.js:21`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `v,fallback=null`
- **Chamadas internas detectadas:** `parse`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
...
## FUNC-00801 — `safeAccount`

- **Fonte:** `cloudflare/oneclick-backend/src/index.js:22`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `u`
- **Chamadas internas detectadas:** —
...
- **Fonte:** `cloudflare/oneclick-backend/src/index.js:23`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `req,env`
- **Chamadas internas detectadas:** `get`
...
- **Fonte:** `cloudflare/oneclick-backend/src/index.js:24`
- **Domínio:** `game-runtime`
- **Forma:** declaration
...
- **Fonte:** `cloudflare/oneclick-backend/src/index.js:25`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `req`
...
## FUNC-00805 — `clampSaveForStorage`

- **Fonte:** `cloudflare/oneclick-backend/src/index.js:26`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `save`
- **Chamadas internas detectadas:** —
...
## FUNC-00806 — `ensureSchema`

- **Fonte:** `cloudflare/oneclick-backend/src/index.js:27`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `env`
- **Chamadas internas detectadas:** —
...
- **Fonte:** `cloudflare/oneclick-backend/src/index.js:28`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `env,type,userId,detail={}`
- **Chamadas internas detectadas:** —
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
...
## FUNC-00808 — `issueToken`

- **Fonte:** `cloudflare/oneclick-backend/src/index.js:29`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `env,user`
- **Chamadas internas detectadas:** `randomSecret`, `sha256Text`, `nowIso`, `bind`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-00809 — `verifyToken`

- **Fonte:** `cloudflare/oneclick-backend/src/index.js:30`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `env,token`
- **Chamadas internas detectadas:** `sha256Text`, `bind`, `nowIso`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-00810 — `requireUser`

- **Fonte:** `cloudflare/oneclick-backend/src/index.js:31`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `req,env`
...
## FUNC-00811 — `revokeCurrent`

- **Fonte:** `cloudflare/oneclick-backend/src/index.js:32`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `req,env`
- **Chamadas internas detectadas:** `bearer`, `bind`, `nowIso`, `sha256Text`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-00812 — `slotSummary`

- **Fonte:** `cloudflare/oneclick-backend/src/index.js:33`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `row`
- **Chamadas internas detectadas:** `safeJson`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-00813 — `hasForbiddenMechanicalResult`

- **Fonte:** `cloudflare/oneclick-backend/src/index.js:34`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `v,depth=0`
- **Chamadas internas detectadas:** —
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
...
## FUNC-00814 — `constructor`

- **Fonte:** `cloudflare/oneclick-backend/src/index.js:37`
- **Domínio:** `game-runtime`
- **Forma:** method
- **Parâmetros:** `ctx,env`
- **Chamadas internas detectadas:** —
...
- **Fonte:** `cloudflare/oneclick-backend/src/index.js:38`
- **Domínio:** `game-runtime`
- **Forma:** method
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `get`
...
- **Fonte:** `cloudflare/oneclick-backend/src/index.js:39`
- **Domínio:** `game-runtime`
- **Forma:** method
- **Parâmetros:** `room`
...
## FUNC-00817 — `liveMembers`

- **Fonte:** `cloudflare/oneclick-backend/src/index.js:40`
- **Domínio:** `game-runtime`
- **Forma:** method
- **Parâmetros:** `room`
- **Chamadas internas detectadas:** `values`, `parse`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Fonte:** `cloudflare/oneclick-backend/src/index.js:41`
- **Domínio:** `game-runtime`
- **Forma:** method
- **Parâmetros:** `req`
- **Chamadas internas detectadas:** `read`, `json`, `cleanText`, `nowIso`, `write`, `liveMembers`, `get`, `test`, `hasForbiddenMechanicalResult`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Fonte:** `cloudflare/oneclick-backend/src/index.js:54`
- **Domínio:** `game-runtime`
- **Forma:** declaration
...
- **Fonte:** `cloudflare/oneclick-backend/src/index.js:55`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `req,env`
...
## FUNC-00821 — `handleApi`

- **Fonte:** `cloudflare/oneclick-backend/src/index.js:57`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `req,env`
- **Chamadas internas detectadas:** `ensureSchema`, `reply`, `bodyJson`, `cleanText`, `test`, `randomBytes`, `hashPassword`, `nowIso`, `bind`, `b64url`, `issueToken`, `randomSecret`, `audit`, `safeAccount`, `unb64url`, `timingSafe`, `aiRoute`, `requireUser`, `safeJson`, `revokeCurrent`, `clampSaveForStorage`, `bearer`, `roomId`, `roomJson`, `hasForbiddenMechanicalResult`
- **Rotas referidas:** `/api/status`, `/api/auth/register`, `/api/auth/login`, `/api/auth/recover`, `/api/ai`, `/api/v84/bootstrap`, `/api/auth/me`, `/api/auth/logout`, `/api/account/slots`, `/api/account/save`, `/api/account/load`, `/api/account/delete`, `/api/cloud/load`, `/api/private/unlock`, `/api/private/leon/load`, `/api/private/leon/save`, `/api/leaderboard`, `/api/friends`, `/api/friends/add`, `/api/online/create`, `/api/online/join`, `/api/online/heartbeat`, `/api/online/room`, `/api/online/message`, `/api/online/messages`, `/api/online/action`, `/api/online/state`, `/api/v84/world/event`, `/api/v84/world/savepoint`
- **Coleções MongoDB:** —
- **Modelos IA:** `@cf/meta/llama-3.2-1b-instruct`
- **DOM IDs:** —
- **Storage keys:** —
- **Env:** `AI`, `DB`, `GAME_ROOMS`
- **Ações UI literais:** —
- **Status:** `STATICALLY_TRACED`

## FUNC-00822 — `assert`

- **Fonte:** `cloudflare/oneclick-backend/test/local-e2e.mjs:2`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `c,m`
- **Chamadas internas detectadas:** —
...
- **Fonte:** `cloudflare/oneclick-backend/test/local-e2e.mjs:3`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `path,{method="POST",token="",body,expected=[200]}={}`
- **Chamadas internas detectadas:** —
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
...
## FUNC-00824 — `originHeaders`

- **Fonte:** `cloudflare/r41-api/src/entry-authoritative.js:9`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `req,env`
- **Chamadas internas detectadas:** `get`
...
- **Chamadas internas detectadas:** `originHeaders`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Fonte:** `cloudflare/r41-api/src/entry-authoritative.js:19`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `value,max=120`
- **Chamadas internas detectadas:** —
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
...
- **Fonte:** `cloudflare/r41-api/src/entry-authoritative.js:20`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `value,fallback=0`
- **Chamadas internas detectadas:** —
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
...
## FUNC-00830 — `validEmail`

- **Fonte:** `cloudflare/r41-api/src/entry-authoritative.js:21`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `value`
- **Chamadas internas detectadas:** `test`
...
## FUNC-00831 — `copyRequest`

- **Fonte:** `cloudflare/r41-api/src/entry-authoritative.js:22`
- **Domínio:** `game-runtime`
- **Forma:** declaration
...
## FUNC-00832 — `ensureAuthorityIndexes`

- **Fonte:** `cloudflare/r41-api/src/entry-authoritative.js:23`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `store`
- **Chamadas internas detectadas:** —
- **Rotas referidas:** —
- **Coleções MongoDB:** `mechanical_profiles`, `users`
- **Modelos IA:** —
- **DOM IDs:** —
- **Storage keys:** —
- **Env:** —
...
- **Fonte:** `cloudflare/r41-api/src/entry-authoritative.js:39`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `env`
- **Chamadas internas detectadas:** `ensureAuthorityIndexes`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-00834 — `cloneBounded`

- **Fonte:** `cloudflare/r41-api/src/entry-authoritative.js:44`
- **Domínio:** `game-runtime`
- **Forma:** declaration
...
## FUNC-00835 — `mechanicalCharacterSnapshot`

- **Fonte:** `cloudflare/r41-api/src/entry-authoritative.js:49`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `character={}`
- **Chamadas internas detectadas:** —
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
...
## FUNC-00836 — `profileKeyFor`

- **Fonte:** `cloudflare/r41-api/src/entry-authoritative.js:54`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `saveData={},source={}`
- **Chamadas internas detectadas:** —
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
...
## FUNC-00837 — `mechanicalProfileFromSave`

- **Fonte:** `cloudflare/r41-api/src/entry-authoritative.js:58`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `saveData={},source={}`
- **Chamadas internas detectadas:** —
...
## FUNC-00838 — `seedMechanicalProfile`

- **Fonte:** `cloudflare/r41-api/src/entry-authoritative.js:63`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `store,userId,saveData,source={}`
- **Chamadas internas detectadas:** —
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
...
## FUNC-00839 — `lockedMechanicalProfile`

- **Fonte:** `cloudflare/r41-api/src/entry-authoritative.js:68`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `store,userId,selector={}`
- **Chamadas internas detectadas:** —
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
...
## FUNC-00840 — `matchingSave`

- **Fonte:** `cloudflare/r41-api/src/entry-authoritative.js:76`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `store,userId,selector={}`
- **Chamadas internas detectadas:** —
...
## FUNC-00841 — `trustedProfile`

- **Fonte:** `cloudflare/r41-api/src/entry-authoritative.js:83`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `store,userId,selector={}`
- **Chamadas internas detectadas:** —
...
## FUNC-00842 — `trustedCharacter`

- **Fonte:** `cloudflare/r41-api/src/entry-authoritative.js:87`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `store,userId,selector={}`
- **Chamadas internas detectadas:** —
...
- **Fonte:** `cloudflare/r41-api/src/entry-authoritative.js:88`
- **Domínio:** `game-runtime`
- **Forma:** declaration
...
## FUNC-00844 — `augmentAccountEmail`

- **Fonte:** `cloudflare/r41-api/src/entry-authoritative.js:89`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `req,env,res`
- **Chamadas internas detectadas:** `clone`, `json`, `db`, `originHeaders`
- **Rotas referidas:** —
...
## FUNC-00845 — `emailAwareAuth`

- **Fonte:** `cloudflare/r41-api/src/entry-authoritative.js:90`
- **Domínio:** `game-runtime`
- **Forma:** declaration
...
## FUNC-00846 — `publicCharacterSnapshot`

- **Fonte:** `cloudflare/r41-api/src/entry-authoritative.js:101`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `character={},acct={},trusted=false`
- **Chamadas internas detectadas:** —
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
...
## FUNC-00847 — `authoritativeMembership`

- **Fonte:** `cloudflare/r41-api/src/entry-authoritative.js:102`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `req,env,ctx,path`
- **Chamadas internas detectadas:** `test`, `fetch`, `account`, `json`, `body`, `db`, `trustedCharacter`, `publicCharacterSnapshot`, `copyRequest`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-00848 — `roomSnapshot`

- **Fonte:** `cloudflare/r41-api/src/entry-authoritative.js:107`
- **Domínio:** `game-runtime`
- **Forma:** declaration
...
## FUNC-00849 — `actionType`

- **Fonte:** `cloudflare/r41-api/src/entry-authoritative.js:108`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `envelope`
- **Chamadas internas detectadas:** —
...
## FUNC-00850 — `serverActionType`

- **Fonte:** `cloudflare/r41-api/src/entry-authoritative.js:109`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `envelope`
- **Chamadas internas detectadas:** `text`, `test`, `actionType`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-00851 — `authoritativeAction`

- **Fonte:** `cloudflare/r41-api/src/entry-authoritative.js:110`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `req,env,ctx`
- **Chamadas internas detectadas:** `json`, `fetch`, `body`, `hasClientResult`, `actionType`, `test`, `account`, `roomSnapshot`, `db`, `trustedProfile`, `serverActionType`, `resolveTerionIntent`, `clone`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-00852 — `authoritativeWorld`

- **Fonte:** `cloudflare/r41-api/src/entry-authoritative.js:118`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `req,env,ctx,path`
- **Chamadas internas detectadas:** `fetch`, `account`, `json`, `body`, `stripClientMechanical`, `copyRequest`, `db`, `trustedProfile`
- **Rotas referidas:** `/api/v84/world/event`, `/api/v84/world/savepoint`
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
- **Storage keys:** —
...
## FUNC-00853 — `authoritativeLeaderboard`

- **Fonte:** `cloudflare/r41-api/src/entry-authoritative.js:123`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `req,env,ctx,path`
- **Chamadas internas detectadas:** `fetch`, `account`, `json`, `db`, `values`, `get`, `finite`
- **Rotas referidas:** `/api/leaderboard`
- **Coleções MongoDB:** `mechanical_profiles`, `users`
- **Modelos IA:** —
- **DOM IDs:** —
- **Storage keys:** —
...
## FUNC-00854 — `authoritativeSlotDelete`

- **Fonte:** `cloudflare/r41-api/src/entry-authoritative.js:127`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `req,env,ctx,path`
- **Chamadas internas detectadas:** `fetch`, `account`, `json`, `body`, `text`, `db`, `oid`, `clone`
- **Rotas referidas:** `/api/account/delete`
- **Coleções MongoDB:** `mechanical_profiles`
- **Modelos IA:** —
- **DOM IDs:** —
- **Storage keys:** —
- **Env:** `MONGODB_URI`, `AUTH_SECRET`
...
## FUNC-00855 — `authoritativeAccountDelete`

- **Fonte:** `cloudflare/r41-api/src/entry-authoritative.js:131`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `req,env,ctx,path`
- **Chamadas internas detectadas:** `fetch`, `account`, `db`, `oid`
- **Rotas referidas:** `/api/auth/delete-account`
- **Coleções MongoDB:** `mechanical_profiles`
- **Modelos IA:** —
- **DOM IDs:** —
- **Storage keys:** —
...
- **Fonte:** `cloudflare/r41-api/src/entry-authoritative.js:132`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `req,env,ctx`
- **Chamadas internas detectadas:** `fetch`, `clone`, `json`, `originHeaders`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **DOM IDs:** —
- **Storage keys:** —
- **Env:** `ALLOWED_ORIGINS`, `ALLOWED_ORIGIN`, `MONGODB_URI`, `MONGODB_DB`, `LEON_PRIVATE_CODE`, `AI`
- **Ações UI literais:** —
- **Status:** `STATICALLY_TRACED`

## FUNC-00859 — `randomBytes`
...
## FUNC-00861 — `hashPassword`

- **Fonte:** `cloudflare/r41-api/src/entry.js:15`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `password,salt,iterations=120000`
- **Chamadas internas detectadas:** `b64url`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
...
- **Fonte:** `cloudflare/r41-api/src/entry.js:16`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `req,env`
- **Chamadas internas detectadas:** `get`
...
- **Forma:** declaration
- **Parâmetros:** `env`
- **Chamadas internas detectadas:** `db`
- **Rotas referidas:** —
...
## FUNC-00867 — `rememberMembership`

- **Fonte:** `cloudflare/r41-api/src/entry.js:21`
- **Domínio:** `game-runtime`
- **Forma:** declaration
...
## FUNC-00868 — `hasMembership`

- **Fonte:** `cloudflare/r41-api/src/entry.js:22`
- **Domínio:** `game-runtime`
- **Forma:** declaration
...
## FUNC-00869 — `touchMembership`

- **Fonte:** `cloudflare/r41-api/src/entry.js:23`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `env,roomId,userId`
- **Chamadas internas detectadas:** `guardDb`
...
## FUNC-00870 — `mechanicalClaim`

- **Fonte:** `cloudflare/r41-api/src/entry.js:26`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `value,depth=0`
- **Chamadas internas detectadas:** `test`
...
## FUNC-00871 — `actionType`

- **Fonte:** `cloudflare/r41-api/src/entry.js:27`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `value`
- **Chamadas internas detectadas:** —
...
## FUNC-00872 — `actionLooksLikeOutcome`

- **Fonte:** `cloudflare/r41-api/src/entry.js:28`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `value`
...
## FUNC-00873 — `guardedOnline`

- **Fonte:** `cloudflare/r41-api/src/entry.js:30`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `req,env,ctx,path`
...
## FUNC-00874 — `remapIdentifier`

- **Fonte:** `cloudflare/r41-api/src/entry.js:50`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `req,path`
...
## FUNC-00875 — `accountExtension`

- **Fonte:** `cloudflare/r41-api/src/entry.js:58`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `req,env,ctx,path`
- **Chamadas internas detectadas:** `currentAccount`, `json`, `guardDb`, `randomSecret`, `randomBytes`, `hashPassword`, `b64url`
- **Rotas referidas:** `/api/auth/recovery-code`, `/api/auth/delete-account`
- **Coleções MongoDB:** `recovery_codes`, `audit_events`, `sessions`, `saves`, `friends`, `room_memberships`, `world_events`, `users`
- **Modelos IA:** —
- **DOM IDs:** —
- **Storage keys:** —
- **Env:** —
...
## FUNC-00876 — `claimLeon`

- **Fonte:** `cloudflare/r41-api/src/entry.js:85`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `req,env,ctx`
...
- **Fonte:** `cloudflare/r41-api/src/entry.js:106`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `req,env`
...
## FUNC-00878 — `statusRoute`

- **Fonte:** `cloudflare/r41-api/src/entry.js:115`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `req,env,ctx`
...
## FUNC-00879 — `mapWorldTick`

- **Fonte:** `cloudflare/r41-api/src/entry.js:125`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `req`
- **Chamadas internas detectadas:** `clone`, `json`
...
- **Fonte:** `cloudflare/r41-api/src/entry.js:133`
- **Domínio:** `game-runtime`
- **Forma:** method
- **Parâmetros:** `req,env,ctx`
- **Chamadas internas detectadas:** `statusRoute`, `aiRoute`, `claimLeon`, `accountExtension`, `remapIdentifier`, `guardedOnline`, `mapWorldTick`
- **Rotas referidas:** `/api/status`, `/api/ai`, `/api/private/claim-leon`, `/api/auth/login`, `/api/auth/recover`
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
- **Storage keys:** —
...
- **Forma:** declaration
- **Parâmetros:** `bytes`
- **Chamadas internas detectadas:** `unb64url`, `hmac`, `timingSafe`, `hashPassword`, `randomBytes`, `randomSecret`, `norm`, `cleanText`, `bearer`, `get`, `test`, `plainId`, `safeAccount`, `cors`, `reply`, `bodyJson`, `json`, `toObjectId`, `nowIso`, `roomId`, `mongo`, `db`, `ensureIndexes`, `issueToken`, `verifyToken`, `parse`, `requireUser`, `revokeCurrent`, `slotSummary`, `clampSaveForStorage`, `audit`, `constructor`, `read`, `write`, `liveMembers`, `values`, `fetch`, `roomCall`, `roomJson`, `aiRoute`
- **Rotas referidas:** `/api/status`, `/api/auth/register`, `/api/auth/login`, `/api/auth/recover`, `/api/ai`, `/api/v84/bootstrap`, `/api/auth/me`, `/api/auth/logout`, `/api/account/slots`, `/api/account/save`, `/api/account/load`, `/api/account/delete`, `/api/cloud/load`, `/api/private/unlock`, `/api/private/leon/load`, `/api/private/leon/save`, `/api/leaderboard`, `/api/friends`, `/api/friends/add`, `/api/online/create`, `/api/online/join`, `/api/online/heartbeat`, `/api/online/room`, `/api/online/message`, `/api/online/messages`, `/api/online/action`, `/api/online/state`, `/api/v84/world/event`, `/api/v84/world/savepoint`
...
## FUNC-00902 — `verifyToken`

- **Fonte:** `cloudflare/r41-api/src/index.js:55`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `env,db,token`
- **Chamadas internas detectadas:** `b64url`, `hmac`, `timingSafe`, `parse`, `unb64url`, `toObjectId`
- **Rotas referidas:** —
...
## FUNC-00904 — `revokeCurrent`

- **Fonte:** `cloudflare/r41-api/src/index.js:57`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `req,env,db`
- **Chamadas internas detectadas:** `bearer`, `parse`, `unb64url`
- **Rotas referidas:** —
- **Coleções MongoDB:** `sessions`
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-00906 — `clampSaveForStorage`
...
## FUNC-00918 — `canonicalAttribute`

- **Fonte:** `cloudflare/r41-api/src/terion-mechanics.js:17`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `requested, actionType`
- **Chamadas internas detectadas:** —
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
...
## FUNC-00919 — `characterModifier`

- **Fonte:** `cloudflare/r41-api/src/terion-mechanics.js:23`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `character={},attribute="tecnica"`
- **Chamadas internas detectadas:** —
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
...
## FUNC-00921 — `classifyTerionRoll`

- **Fonte:** `cloudflare/r41-api/src/terion-mechanics.js:40`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `hope,doom,modifier,dc`
- **Chamadas internas detectadas:** —
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
...
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `random=Math.random`
- **Chamadas internas detectadas:** `clamp`, `num`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-00923 — `resolveTerionIntent`

- **Fonte:** `cloudflare/r41-api/src/terion-mechanics.js:50`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `{intent={},character={},random=Math.random}={}`
- **Chamadas internas detectadas:** —
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
...
## FUNC-00925 — `blockedClientKey`

- **Fonte:** `cloudflare/r41-api/src/terion-mechanics.js:63`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `key`
- **Chamadas internas detectadas:** `mechanicalKey`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-00926 — `hasClientResult`

- **Fonte:** `cloudflare/r41-api/src/terion-mechanics.js:65`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `payload`
- **Chamadas internas detectadas:** `blockedClientKey`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-00927 — `stripClientMechanical`
...
- **Forma:** arrow
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `open`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** `sns-account-style`
- **Storage keys:** —
- **Env:** —
- **Ações UI literais:** —
- **Status:** `STATICALLY_TRACED`

## FUNC-00935 — `ensureButton`
...
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** `sns-account-button`
- **Storage keys:** —
- **Env:** —
- **Ações UI literais:** —
- **Status:** `STATICALLY_TRACED`

## FUNC-00936 — `updateButton`

- **Fonte:** `r41-account-ui.js:22`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `ensureButton`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `name,label,type="text",extra=""`
- **Chamadas internas detectadas:** `esc`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
...
## FUNC-00939 — `unauthBody`

- **Fonte:** `r41-account-ui.js:25`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `tabs`, `field`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `message="",kind=""`
- **Chamadas internas detectadas:** `updateButton`, `esc`, `authBody`, `unauthBody`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** `sns-account-overlay`
- **Storage keys:** —
- **Env:** —
...
## FUNC-00943 — `submitLogin`

- **Fonte:** `r41-account-ui.js:29`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `e`
- **Chamadas internas detectadas:** `values`, `login`, `render`, `errorText`, `updateButton`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-00944 — `submitRegister`

- **Fonte:** `r41-account-ui.js:30`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `e`
- **Chamadas internas detectadas:** `values`, `render`, `register`, `errorText`, `updateButton`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-00945 — `submitRecover`

- **Fonte:** `r41-account-ui.js:31`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `e`
- **Chamadas internas detectadas:** `values`, `render`, `recover`, `errorText`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `render`, `errorText`, `updateButton`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-00947 — `newRecoveryCode`

- **Fonte:** `r41-account-ui.js:33`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `generateRecoveryCode`, `render`, `errorText`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `style`, `updateButton`, `me`, `get`, `open`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Modelos IA:** —
- **DOM IDs:** —
- **Storage keys:** `sns-api-origin`, `sns-r41-api-origin`
- **Env:** —
- **Ações UI literais:** —
- **Status:** `STATICALLY_TRACED`

## FUNC-00953 — `allowedOverride`
...
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `getItem`, `setItem`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-00957 — `captureClaim`

- **Fonte:** `r41-github-api.js:14`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `get`, `setItem`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-00960 — `applyLeonClaim`

- **Fonte:** `r41-github-api.js:27`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `response,mapped`
- **Chamadas internas detectadas:** `getItem`, `clone`, `json`, `removeItem`, `apiOrigin`, `set`
...
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `route,body,method="POST"`
- **Chamadas internas detectadas:** `fetch`, `json`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
...
- **Domínio:** `game-runtime`
- **Forma:** method
- **Parâmetros:** `username,password,displayName,email`
- **Chamadas internas detectadas:** `request`, `setToken`
- **Rotas referidas:** `/api/auth/register`
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
- **Storage keys:** —
...
- **Domínio:** `game-runtime`
- **Forma:** method
- **Parâmetros:** `identifier,password`
- **Chamadas internas detectadas:** `request`, `setToken`
- **Rotas referidas:** `/api/auth/login`
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
- **Storage keys:** —
...
- **Forma:** method
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `token`, `request`, `setToken`
- **Rotas referidas:** `/api/auth/me`
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Domínio:** `game-runtime`
- **Forma:** method
- **Parâmetros:** `identifier,recoveryCode,newPassword`
- **Chamadas internas detectadas:** `request`
- **Rotas referidas:** `/api/auth/recover`
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
- **Storage keys:** —
...
## FUNC-00967 — `generateRecoveryCode`
...
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `request`
- **Rotas referidas:** `/api/auth/recovery-code`
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
- **Storage keys:** —
...
- **Forma:** arrow-one
- **Parâmetros:** `id`
- **Chamadas internas detectadas:** `active`, `removeItem`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-00975 — `activeAccountEntry`

- **Fonte:** `src/r41-account-active-slot.js:26`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `id=active(`
- **Chamadas internas detectadas:** `key`, `parse`, `getItem`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-00979 — `persistAccountSave`

- **Fonte:** `src/r41-account-active-slot.js:58`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `entry,save`
- **Chamadas internas detectadas:** `setItem`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
...
## FUNC-00980 — `applyKuraiMode`

- **Fonte:** `src/r41-account-active-slot.js:65`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `save,mode`
- **Chamadas internas detectadas:** —
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
...
## FUNC-00981 — `setKuraiModeDirect`

- **Fonte:** `src/r41-account-active-slot.js:77`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `button`
- **Chamadas internas detectadas:** `active`, `activeAccountEntry`, `parse`, `getItem`, `copy`, `applyKuraiMode`, `persistAccountSave`, `setItem`, `authenticated`, `apiPost`, `warn`
- **Rotas referidas:** `/api/account/save`
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-00983 — `removeOnlineIntentNotice`
...
## FUNC-00984 — `showOnlineIntentNotice`

- **Fonte:** `src/r41-account-active-slot.js:105`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `button,message,isError=false`
- **Chamadas internas detectadas:** `removeOnlineIntentNotice`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-00985 — `replayOnlineIntentWhenReady`

- **Fonte:** `src/r41-account-active-slot.js:116`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `intent,button`
- **Chamadas internas detectadas:** `showOnlineIntentNotice`, `onlineBridgeReady`, `removeOnlineIntentNotice`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** `r41-online-intent`
...
## FUNC-00986 — `finishOnlineTransition`

- **Fonte:** `src/r41-account-active-slot.js:158`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `entry,id,save`
- **Chamadas internas detectadas:** `persistAccountSave`, `apiPost`, `warn`, `setItem`
- **Rotas referidas:** `/api/account/save`
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-00987 — `createOnlineRoomDirect`

- **Fonte:** `src/r41-account-active-slot.js:165`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `button`
- **Chamadas internas detectadas:** `authenticated`, `active`, `activeAccountEntry`, `copy`, `apiPost`, `characterSummary`, `finishOnlineTransition`
- **Rotas referidas:** `/api/online/create`
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** `online-room-title`
- **Storage keys:** —
- **Env:** —
- **Ações UI literais:** —
- **Status:** `STATICALLY_TRACED`

## FUNC-00988 — `joinOnlineRoomDirect`
...
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** `online-room-id`
- **Storage keys:** —
- **Env:** —
- **Ações UI literais:** —
- **Status:** `STATICALLY_TRACED`

## FUNC-00989 — `reconcileOnlineRoomMirror`

- **Fonte:** `src/r41-account-active-slot.js:201`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `authenticated`, `active`, `activeAccountEntry`, `parse`, `getItem`, `sameCharacter`, `copy`, `setItem`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-00990 — `clearSatisfiedRecovery`

- **Fonte:** `src/r41-account-active-slot.js:222`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `active`, `activeAccountEntry`, `parse`, `getItem`, `removeItem`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-00991 — `slotControl`

- **Fonte:** `src/r41-account-active-slot.js:228`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `id`
- **Chamadas internas detectadas:** `accountChooserVisible`, `returnToRequestedScreen`, `getItem`, `removeItem`, `recoverActiveSlot`, `authenticated`, `active`, `clearSatisfiedRecovery`, `repairAndRecover`, `reconcileOnlineRoomMirror`, `onlineBridgeReady`, `replayOnlineIntentWhenReady`, `activeAccountEntry`, `parse`, `setKuraiModeDirect`, `createOnlineRoomDirect`, `joinOnlineRoomDirect`, `remember`, `forget`, `start`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** `main-nav`, `screen`, `r41-online-intent`, `online-room-id`, `app`
- **Storage keys:** —
- **Env:** —
- **Ações UI literais:** `account-load`, `load-account-slot`
- **Status:** `STATICALLY_TRACED`

## FUNC-00992 — `accountChooserVisible`
...
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** `main-nav`, `screen`
- **Storage keys:** —
- **Env:** —
- **Ações UI literais:** `account-load`, `load-account-slot`
- **Status:** `STATICALLY_TRACED`

## FUNC-00993 — `returnToRequestedScreen`

- **Fonte:** `src/r41-account-active-slot.js:240`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `getItem`, `removeItem`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-00994 — `recoverActiveSlot`

- **Fonte:** `src/r41-account-active-slot.js:246`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `authenticated`, `accountChooserVisible`, `active`, `slotControl`, `clearSatisfiedRecovery`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** `screen`
...
## FUNC-00995 — `repairAndRecover`

- **Fonte:** `src/r41-account-active-slot.js:263`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `reconcileOnlineRoomMirror`, `clearSatisfiedRecovery`, `returnToRequestedScreen`, `recoverActiveSlot`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** arrow
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `repairAndRecover`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** `app`
...
## FUNC-01034 — `activeSave`

- **Fonte:** `src/r41-final-ui-repair.js:14`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `getItem`, `parse`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-01035 — `ensureKuraiResource`
...
## FUNC-01038 — `localProgressKeys`

- **Fonte:** `src/r41-local-reset-fix.js:20`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `key`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-01039 — `resetLocalProgress`

- **Fonte:** `src/r41-local-reset-fix.js:30`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `localProgressKeys`, `removeItem`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Fonte:** `src/r41-online-bridge-recovery.js:15`
- **Domínio:** `game-runtime`
- **Forma:** arrow-one
- **Parâmetros:** `raw`
- **Chamadas internas detectadas:** —
...
## FUNC-01041 — `runtimeOnline`

- **Fonte:** `src/r41-online-bridge-recovery.js:17`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** —
...
## FUNC-01042 — `runtimeRoomId`

- **Fonte:** `src/r41-online-bridge-recovery.js:21`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `online=runtimeOnline(`
- **Chamadas internas detectadas:** —
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
...
## FUNC-01043 — `activeEntry`

- **Fonte:** `src/r41-online-bridge-recovery.js:25`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `getItem`, `key`, `parse`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-01044 — `roomContext`

- **Fonte:** `src/r41-online-bridge-recovery.js:37`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `activeEntry`, `parse`, `getItem`, `runtimeRoomId`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Fonte:** `src/r41-online-bridge-recovery.js:46`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `runtimeOnline`, `runtimeRoomId`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-01047 — `clearSatisfied`

- **Fonte:** `src/r41-online-bridge-recovery.js:53`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `ctx,b`
- **Chamadas internas detectadas:** `removeItem`
...
## FUNC-01048 — `recoverBridge`

- **Fonte:** `src/r41-online-bridge-recovery.js:63`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `ctx=roomContext(`
- **Chamadas internas detectadas:** `fetch`, `runtimeOnline`, `removeItem`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-01049 — `requestOneRecovery`

- **Fonte:** `src/r41-online-bridge-recovery.js:103`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `ctx`
- **Chamadas internas detectadas:** `marker`, `getItem`, `setItem`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Fonte:** `src/r41-online-bridge-recovery.js:115`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `roomContext`, `bridge`, `removeItem`, `clearSatisfied`, `recoverBridge`, `requestOneRecovery`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Fonte:** `src/r41-online-bridge-recovery.js:134`
- **Domínio:** `game-runtime`
- **Forma:** arrow
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `tick`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-01055 — `legacySlotKey`

- **Fonte:** `src/r41-v82-combat-bridge.js:17`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `activeSlotId`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-01056 — `accountEntries`

- **Fonte:** `src/r41-v82-combat-bridge.js:18`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `activeSlotId`, `key`, `parseSave`, `getItem`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-01057 — `readSaveEntry`

- **Fonte:** `src/r41-v82-combat-bridge.js:31`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `accountEntries`, `legacySlotKey`, `parseSave`, `getItem`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-01058 — `readRuntimeSave`

- **Fonte:** `src/r41-v82-combat-bridge.js:39`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `readSaveEntry`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-01059 — `readPersistedSave`

- **Fonte:** `src/r41-v82-combat-bridge.js:40`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `readRuntimeSave`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-01060 — `writeSave`

- **Fonte:** `src/r41-v82-combat-bridge.js:41`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `save`
- **Chamadas internas detectadas:** `readSaveEntry`, `legacySlotKey`, `setItem`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-01064 — `readCharacterVitals`
...
## FUNC-01068 — `persistPresentation`
...
## FUNC-01069 — `installPublicApiBridge`
...
- **Forma:** arrow
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `readPersistedSave`, `clone`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Domínio:** `tooling`
- **Forma:** declaration
- **Parâmetros:** `route,{method="POST",body,auth="",expected=[200]}={}`
- **Chamadas internas detectadas:** —
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
...
## FUNC-01092 — `readSaveV2`

- **Fonte:** `tools/browser-gameplay-e2e-v2.mjs:16`
- **Domínio:** `tooling`
- **Forma:** declaration
- **Parâmetros:** `page`
- **Chamadas internas detectadas:** `parse`, `getItem`, `key`, `tryParse`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-01094 — `registerV2`

- **Fonte:** `tools/browser-gameplay-e2e-v2.mjs:48`
- **Domínio:** `tooling`
- **Forma:** declaration
- **Parâmetros:** `page`
- **Chamadas internas detectadas:** `assert`, `ok`, `status`, `count`, `getItem`, `pass`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-01095 — `seedNormalV2`

- **Fonte:** `tools/browser-gameplay-e2e-v2.mjs:66`
- **Domínio:** `tooling`
- **Forma:** declaration
- **Parâmetros:** `page`
- **Chamadas internas detectadas:** `normalFixture`, `fetch`, `json`, `assert`, `pass`, `count`, `readSave`
- **Rotas referidas:** `/api/account/save`, `/api/account/slots`
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** `main-nav`, `screen`
- **Storage keys:** —
...
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** `main-nav`, `screen`, `sns-account-overlay`
- **Storage keys:** —
- **Env:** —
- **Ações UI literais:** —
- **Status:** `STATICALLY_TRACED`

## FUNC-01097 — `seedNormalV3`

- **Fonte:** `tools/browser-gameplay-e2e-v3.mjs:10`
- **Domínio:** `tooling`
- **Forma:** declaration
- **Parâmetros:** `page`
- **Chamadas internas detectadas:** `normalFixture`, `fetch`, `json`, `assert`, `pass`, `count`, `readSave`, `getItem`
- **Rotas referidas:** `/api/account/save`, `/api/account/slots`
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** `main-nav`, `screen`
- **Storage keys:** `narutoShinobiNoShoPcV5Active`
- **Env:** —
- **Ações UI literais:** —
- **Status:** `STATICALLY_TRACED`
...
- **Fonte:** `tools/browser-gameplay-e2e-v4.mjs:33`
- **Domínio:** `tooling`
- **Forma:** arrow-one
- **Parâmetros:** `x`
- **Chamadas internas detectadas:** —
...
- **Fonte:** `tools/browser-gameplay-e2e-v4.mjs:47`
- **Domínio:** `tooling`
- **Forma:** arrow-one
- **Parâmetros:** `x`
- **Chamadas internas detectadas:** —
...
## FUNC-01108 — `masterState`

- **Fonte:** `tools/browser-gameplay-e2e.mjs:67`
- **Domínio:** `tooling`
- **Forma:** declaration
- **Parâmetros:** `page`
- **Chamadas internas detectadas:** `readSave`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-01110 — `playVisibleMinigame`

- **Fonte:** `tools/browser-gameplay-e2e.mjs:70`
- **Domínio:** `tooling`
- **Forma:** declaration
- **Parâmetros:** `page`
- **Chamadas internas detectadas:** `count`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
- **Forma:** declaration
- **Parâmetros:** `page`
- **Chamadas internas detectadas:** `assert`, `ok`, `status`, `getItem`, `pass`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-01112 — `seedNormal`

- **Fonte:** `tools/browser-gameplay-e2e.mjs:107`
- **Domínio:** `tooling`
- **Forma:** declaration
- **Parâmetros:** `page`
- **Chamadas internas detectadas:** `normalFixture`, `setItem`, `readSave`, `assert`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-01113 — `testNormalGameplay`

- **Fonte:** `tools/browser-gameplay-e2e.mjs:118`
- **Domínio:** `tooling`
- **Forma:** declaration
- **Parâmetros:** `page,token`
- **Chamadas internas detectadas:** `readSave`, `assert`, `navigate`, `contract`, `count`, `masterState`, `pass`, `r41State`, `playVisibleMinigame`, `values`, `sleep`, `fetch`, `json`
- **Rotas referidas:** `/api/account/load`
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
- **Storage keys:** —
...
## FUNC-01114 — `testKurai`

- **Fonte:** `tools/browser-gameplay-e2e.mjs:283`
- **Domínio:** `tooling`
- **Forma:** declaration
- **Parâmetros:** `browser`
- **Chamadas internas detectadas:** `leonFixture`, `setItem`, `navigate`, `readSave`, `contract`, `test`, `close`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-01116 — `cloneLocal`

- **Fonte:** `tools/browser-gameplay-local-e2e.mjs:23`
- **Domínio:** `tooling`
- **Forma:** arrow-one
- **Parâmetros:** `v`
- **Chamadas internas detectadas:** —
...
## FUNC-01117 — `slotSummaryLocal`

- **Fonte:** `tools/browser-gameplay-local-e2e.mjs:24`
- **Domínio:** `tooling`
- **Forma:** arrow
- **Parâmetros:** `slotId,save`
- **Chamadas internas detectadas:** —
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
...
- **Fonte:** `tools/browser-gameplay-local-e2e.mjs:37`
- **Domínio:** `tooling`
- **Forma:** arrow
- **Parâmetros:** `data,status=200`
- **Chamadas internas detectadas:** —
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
...
## FUNC-01119 — `testKurai`

- **Fonte:** `tools/browser-gameplay-local-e2e.mjs:86`
- **Domínio:** `tooling`
- **Forma:** declaration
- **Parâmetros:** `browser`
...
- **Modelos IA:** —
- **DOM IDs:** —
- **Storage keys:** `sns-v841-active-account-slot`, `narutoShinobiNoShoPcV5Active`
- **Env:** `GAMEPLAY_SCOPE`
- **Ações UI literais:** —
- **Status:** `STATICALLY_TRACED`

## FUNC-01120 — `testKurai`

- **Fonte:** `tools/browser-gameplay-local-e2e.mjs:88`
- **Domínio:** `tooling`
- **Forma:** declaration
- **Parâmetros:** `context`
- **Chamadas internas detectadas:** `setItem`, `key`, `fetch`, `close`, `text`, `status`, `test`, `resolve`
...
## FUNC-01136 — `actionHandlerEvidence`
...
## FUNC-01146 — `aliasesForDatasetAction`
...
## FUNC-01183 — `isGameRuntimeSource`
...
## FUNC-01196 — `makeHarness`

- **Fonte:** `tools/test-online-bridge-recovery.mjs:15`
- **Domínio:** `tooling`
- **Forma:** declaration
- **Parâmetros:** `{responseRoomId='room-1',responseOk=true}={}`
- **Chamadas internas detectadas:** —
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
...
- **Fonte:** `tools/test-online-bridge-recovery.mjs:58`
- **Domínio:** `tooling`
- **Forma:** declaration
