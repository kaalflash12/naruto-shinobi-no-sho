...
- **Forma:** declaration
- **Parâmetros:** `bytes`
- **Chamadas internas detectadas:** `unb64url`, `hmac`, `timingSafe`, `hashPassword`, `randomBytes`, `randomSecret`, `norm`, `cleanText`, `bearer`, `get`, `test`, `plainId`, `safeAccount`, `cors`, `reply`, `bodyJson`, `json`, `toObjectId`, `nowIso`, `roomId`, `mongo`, `db`, `ensureIndexes`, `issueToken`, `verifyToken`, `requireUser`, `revokeCurrent`, `slotSummary`, `clampSaveForStorage`, `audit`, `constructor`, `read`, `write`, `liveMembers`, `values`, `fetch`, `roomCall`, `roomJson`, `aiRoute`
- **Rotas referidas:** `/api/status`, `/api/auth/register`, `/api/auth/login`, `/api/auth/recover`, `/api/ai`, `/api/v84/bootstrap`, `/api/auth/me`, `/api/auth/logout`, `/api/account/slots`, `/api/account/save`, `/api/account/load`, `/api/account/delete`, `/api/cloud/load`, `/api/private/unlock`, `/api/private/leon/load`, `/api/private/leon/save`, `/api/leaderboard`, `/api/friends`, `/api/friends/add`, `/api/online/create`, `/api/online/join`, `/api/online/heartbeat`, `/api/online/room`, `/api/online/message`, `/api/online/messages`, `/api/online/action`, `/api/online/state`, `/api/v84/world/event`, `/api/v84/world/savepoint`
...
## FUNC-00955 — `mapTarget`

- **Fonte:** `r41-github-api.js:18`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `raw`
...
- **Fonte:** `r41-github-api.js:23`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `init,api`
- **Chamadas internas detectadas:** `publishableKey`, `token`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-00957 — `applyLeonClaim`

- **Fonte:** `r41-github-api.js:29`
- **Domínio:** `game-runtime`
- **Forma:** declaration
- **Parâmetros:** `response,mapped`
- **Chamadas internas detectadas:** `clone`, `json`, `publishableKey`, `apiOrigin`
...
## FUNC-00964 — `generateRecoveryCode`

- **Fonte:** `r41-github-api.js:64`
- **Domínio:** `game-runtime`
- **Forma:** method
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `request`
...
- **Fonte:** `tools/browser-account-live.mjs:10`
- **Domínio:** `tooling`
- **Forma:** declaration
- **Parâmetros:** `cond,msg`
- **Chamadas internas detectadas:** —
...
## FUNC-01020 — `readSaveV2`

- **Fonte:** `tools/browser-gameplay-e2e-v2.mjs:16`
- **Domínio:** `tooling`
- **Forma:** declaration
- **Parâmetros:** `page`
- **Chamadas internas detectadas:** `tryParse`
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
...
## FUNC-01036 — `playVisibleMinigame`
...
## FUNC-01057 — `actionHandlerEvidence`
...
## FUNC-01066 — `aliasesForDatasetAction`
...
## FUNC-01103 — `isGameRuntimeSource`
...
- **Domínio:** `tooling`
- **Forma:** declaration
- **Parâmetros:** `route,{method='GET',body,token}={}`
- **Chamadas internas detectadas:** —
- **Rotas referidas:** —
- **Coleções MongoDB:** —
- **Modelos IA:** —
...
- **Fonte:** `tools/supabase-live-e2e.mjs:18`
- **Domínio:** `tooling`
- **Forma:** declaration
- **Parâmetros:** `(nenhum explícito)`
- **Chamadas internas detectadas:** `api`
- **Rotas referidas:** `/api/auth/delete-account`
- **Coleções MongoDB:** —
- **Modelos IA:** —
- **DOM IDs:** —
