...
const coherencePath=process.env.PUBLIC_RELEASE_REPORT||'audit/PUBLIC-RELEASE-COHERENCE.json';
...
if(!fs.existsSync(coherencePath))throw new Error('GAMEPLAY_PUBLIC_RELEASE_COHERENCE_MISSING');
...
if(coherence?.ok!==true||coherence?.status!=='PASS_PUBLIC_RELEASE_COHERENCE')throw new Error('GAMEPLAY_PUBLIC_RELEASE_NOT_COHERENT');
...
report.provenance={
  ...
  publicReleaseCoherence:'PASS_PUBLIC_RELEASE_COHERENCE',
