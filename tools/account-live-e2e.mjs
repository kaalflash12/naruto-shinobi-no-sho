...
try{
 const status=await call(authOrigin,"/api/auth/status",{method:"GET"});ok("authStatus",status.data?.ok===true&&status.data?.nativeEmailBridge===true,"auth status inválido");
